...
export default function ProductDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <footer
        className="bg-[#111] text-white pt-[72px] px-[5.25vw] pb-[21px] mt-0 max-[800px]:pt-[48px] max-[800px]:px-[21px] max-[800px]:pb-[19px] max-[760px]:m-0"
        id="contact"
      >
        <section className="pb-[65px] border-b border-[#444] flex flex-col items-start max-[800px]:pb-[47px]">
          <p className="mb-[11px] text-[10px] tracking-[.16em] uppercase font-bold text-accent">
            Need a hand?
          </p>
          <h2 className="text-[clamp(43px,6vw,86px)] leading-[.82] tracking-[-.09em] mb-[29px] max-[800px]:text-[49px]">
            Let&apos;s find your
            <br />
            <em className="font-[Georgia,serif] font-normal">next pair.</em>
          </h2>
          <a
            className="text-[#111] bg-accent no-underline px-[17px] py-[14px] text-[10px] uppercase tracking-[.09em] font-bold flex items-center gap-[30px] [&_svg]:w-[15px]"
            href="mailto:hello@primekicks.in"
          >
            Contact us <Icon name="arrow" />
          </a>
        </section>
        <div className="grid grid-cols-[1fr_1fr_1.7fr] gap-[30px] pt-[39px] pb-[53px] max-[800px]:grid-cols-2 max-[800px]:py-[31px] max-[800px]:gap-x-[16px] max-[800px]:gap-y-[28px]">
          <div className="grid content-start gap-[11px]">
            <p className="text-[10px] uppercase tracking-[.1em] font-bold text-[#aaa] mb-[5px]">
              Prime Kicks
            </p>
          ...
          <div className="grid content-start gap-[11px] max-[800px]:col-[1/-1] max-[800px]:mt-[10px]">
            ...
            >
              <input
                className="min-w-0 flex-1 border-0 bg-transparent text-white py-[10px] text-[12px] focus:outline-none"
                type="email"
